...
Given the hierarchical structure of the data (observations nested in survey waves), we applied a longitudinal multilevel strategy [@singer_applied_2009]. In this matter, longitudinal multilevel models are suited to account for the shared variance among units in the data to estimate standard errors better as observations are nested within respondents. Since individuals share variance within themselves over time, if the error structure is not considered, it would be as if they were considered different individuals. Multilevel models allow a solution in regression estimation by adding a random term that represents the variance associated with the nested structure of the data (random effects). Consequently, the linear multilevel models are estimated using the R library "lme4" [@singer_applied_2009, p.4].
...
#                                      "Subjective Social Status",
                ...
                groups = list("Wave (Ref.= Wave 2016)" = 2:5,
                  "Household Income (Ref.= Quintile 1)" = 8:12,
                  "Age (Ref.= 18-29)" = 13:15,
...
The authors recognize the support of ANID/FONDECYT grant 1210847; the Center for Conflict and Social Cohesion Studies (COES) grant ANID/FONDAP 1513009; and Millenium Nucleus on Digital Inequalities and Opportunities (NUDOS) NCS2022_046
...
#                omit.coef = omit,
                ...
                groups = list("Wave (Ref.= Wave 2016)" = 2:5,
                  ...
                  "Household Income (Ref.= Quintile 1)" = 11:15,
                  "Age (Ref.= 18-29)" = 17:19,
