...
h6 <- "ola+education+ing_pc_rec+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort"
h1b <- "ola+education+ing_pc_rec+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+merit_effort*ola"
h3b <- "ola+education+ing_pc_rec+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+merit_talent*ola"
h4b <- "ola+education+ing_pc_rec+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+des_perc*ola"
h5b <- "ola+education+ing_pc_rec+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+ing_pc_rec*ola"
...
educ4 <- lmer(formula(paste0("just_educ~",h4b,"+(ola+des_perc|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ5 <- lmer(formula(paste0("just_educ~",h5b,"+(ola+ing_pc_rec|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ6 <- lmer(formula(paste0("just_educ~",h6,"+(1|idencuesta)")),data = df_study1, weights = ponderador_long_total)
