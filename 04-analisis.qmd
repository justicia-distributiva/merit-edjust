...
@fig-correlation presents a correlation matrix of the main variables analyzed, using data from the first wave. In this matrix, the correlations vary between low and moderate values. The correlations between justification of educational inequality with the two covid variables are positive, but low. In addition, justification of education inequality depicts a moderate and negative association with the perception of inequality (_r_=-0.34, p<.01) and a moderate and positive association with both meritocracy perception variables (_r_=0.29, p<.01; _r_=0.24, p<.01). Regarding the perception of inequality, it presents a moderate and negative association with both meritocracy perception variables (_r_=-0.18, p<.01; _r_=-0.08, p<.01). Finally, the two meritocracy variables present a high and positive association with each other (_r_=0.76, p<.01).
...
texreg::knitreg(list(educ0, educ1, educ2, educ3, educ4, educ5, educ6, educ7)
                     ,
                digits = 3,
