...
df_study1 <- 
  ...
  select(idencuesta,ola,comuna, ponderador_long_total,just_educ, des_perc, merit_effort, merit_talent, education=educ,quintil1:sexo, covid_economia, covid_beneficios, inc_pcmed) %>% 
  na.omit() %>% 
...
h0 <- "ola"
h1 <- "ola_num+ola_2"
h2 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo"
h3 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id"
h4 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia"
h5 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios"
h6 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc"
h7 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent"
h8 <- "ola_num+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort"
...
h6 <- "ola+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort"
h1b <- "ola+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+merit_effort*inc_pcmed"
h3b <- "ola+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+merit_talent*inc_pcmed"
h4b <- "ola+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+des_perc*inc_pcmed"
h5b <- "ola+ola_2+education+inc_pcmed+ess+edad+sexo+pos_id+covid_economia+covid_beneficios+des_perc+merit_talent+merit_effort+inc_pcmed*ola"
# A. justification educational inequality
educ1 <- lmer(formula(paste0("just_educ~",h1b,"+(inc_pcmed+merit_effort|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ3 <- lmer(formula(paste0("just_educ~",h3b,"+(inc_pcmed+merit_talent|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ4 <- lmer(formula(paste0("just_educ~",h4b,"+(inc_pcmed+des_perc|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ5 <- lmer(formula(paste0("just_educ~",h5b,"+(ola+inc_pcmed|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ6 <- lmer(formula(paste0("just_educ~",h6,"+(1|idencuesta)")),data = df_study1, weights = ponderador_long_total)

# table 3: interacciones
omit <- "(education)|(ess)|(edad)|(sexo)|(pos_id)|(covid_beneficios)|(covid_economia)"
texreg::knitreg(list(educ6,educ3,educ1, educ4, educ5),
                ...
                include.loglik = FALSE,
                include.aic = FALSE,
                custom.model.names = c("Model 8", "Model 9", "Model 10", "Model 11", "Model 12"),
                custom.coef.names = c("Intercept",
                                      "Wave",
                                      "Wave^2",
                                      "Income",
