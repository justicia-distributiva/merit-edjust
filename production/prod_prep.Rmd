...
load(file = here::here("input/data-proc/df_gini_comunas_wide.RData"))
load(file = here::here("input/data-proc/df_gini_comunas_long.RData"))
...
df_study1_long_comunas <- 
 dplyr::left_join(x = df_study1_long_comunas,
                  y = select(df_gini_comunas_wide, comunacod,starts_with("gini")), 
                  by = c("comunacod"))
