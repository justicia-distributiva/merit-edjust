...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_simpat, 
                      label = "Sympathy for [PER/HAI/VEN] living in Chile") 
elsoc_long_2016_2021$in_simpat <-
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_simili, 
                      label = "Similarity between Chileans and [PER/HAI/VEN]") 
elsoc_long_2016_2021$in_simili <-
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_valfam, 
                      label = "Family value of immigrant friends [PER/HAI/VEN]") 
sjmisc::frq(elsoc_long_2016_2021$in_valfam)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_valami, 
                      label = "Friends value of immigrant friends [PER/HAI/VEN]") 
sjmisc::frq(elsoc_long_2016_2021$in_valami)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_amsimb, 
                      label = "Loose of identity because of immigrants")
sjmisc::frq(elsoc_long_2016_2021$in_amsimb) 
# Revert item
elsoc_long_2016_2021$in_amsimb<- 
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_acpier, 
                      label = "Immigrant keeping their customs") 
sjmisc::frq(elsoc_long_2016_2021$in_acpier)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_amigcl, 
                      label = "Immigrants [PER/HAI/VEN] have Chilean friends") 
sjmisc::frq(elsoc_long_2016_2021$in_amigcl)
...
c("Comuna",
  "Codigo Comuna",
  "Proportion of immigrant population (weighted) - CASEN 2017 - Municipality",
  "Number of immigrant population - CENSUS 2017 - Municipality",
  "Proportion of immigrant population - CENSUS 2017 - Municipality",
  "Number of immigrant population - CIT 2017 - Municipality (using census tract)",
  "Proportion of immigrant population (CIT / DEM)- CIT 2017 and INE/DEM 2017 - Communal",
  "Proportion of projected immigrant population - INE/DEM 2018 - Communal",
  "Proportion of projected immigrant population -  INE/DEM 2019 - Comunal",
  "Proportion of projected immigrant population -  INE/DEM 2020 - Comunal",
  "Proportion of immigrant population (weighted) - CASEN 2020 - Municipality",
  "Change in the proportion of the immigrant population between 2017 and 2020 - CASEN")
