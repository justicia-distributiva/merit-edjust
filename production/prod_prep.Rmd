...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_simpat, 
                      label = "Sympathy for [PER/VEN] living in Chile") 
elsoc_long_2016_2021$in_simpat <-
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_simili, 
                      label = "Similarity between Chileans and [PER/VEN]") 
elsoc_long_2016_2021$in_simili <-
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_ansied, 
                      label = "Interaction anxiety with [PER/VEN].") 
elsoc_long_2016_2021$in_ansied <-
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_valfam, 
                      label = "Family value of migrant friends [PER/VEN]") 
sjmisc::frq(elsoc_long_2016_2021$in_valfam)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_valami, 
                      label = "Friends value of migrant friends [PER/VEN]") 
sjmisc::frq(elsoc_long_2016_2021$in_valami)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_amsimb, 
                      label = "Loose of identity because of migrants (reverse)")
sjmisc::frq(elsoc_long_2016_2021$in_amsimb) 
# Revert item
elsoc_long_2016_2021$in_amsimb<- 
  sjmisc::rec(elsoc_long_2016_2021$in_amsimb,rec = "rev")
sjmisc::frq(elsoc_long_2016_2021$in_amsimb) # check reverted item
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_acpier, 
                      label = "Migrant keeping their customs") 
sjmisc::frq(elsoc_long_2016_2021$in_acpier)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_acadop, 
                      label = "Adoption of Chilean customs") 
sjmisc::frq(elsoc_long_2016_2021$in_acadop)
...
sjlabelled::set_label(x = elsoc_long_2016_2021$in_amigcl, 
                      label = "migrants [PER/VEN] have Chilean friends") 
sjmisc::frq(elsoc_long_2016_2021$in_amigcl)


# Average variables___________________________________________________________

elsoc_long_2016_2021 <- elsoc_long_2016_2021 %>% 
  mutate(conviviality=as.numeric((in_ansied+in_simpat+in_valfam+in_valami+in_amigcl)/5),
         identity= as.numeric((in_simili+in_amsimb+in_acpier+in_acadop)/4),
         threat = as.numeric(in_amreal))

sjmisc::frq(elsoc_long_2016_2021$conviviality)
elsoc_long_2016_2021$conviviality <- 
sjlabelled::set_label(x = elsoc_long_2016_2021$conviviality, 
                      label = "Conviviality")
sjmisc::frq(elsoc_long_2016_2021$conviviality)

sjmisc::frq(elsoc_long_2016_2021$identity)
elsoc_long_2016_2021$identity <- 
sjlabelled::set_label(x = elsoc_long_2016_2021$identity, 
                      label = "Identity")
sjmisc::frq(elsoc_long_2016_2021$identity)
...
elsoc_long_2016_2021$educ <- forcats::fct_rev(elsoc_long_2016_2021$educ)
...
elsoc_long_2016_2021$quintil <- forcats::fct_rev(elsoc_long_2016_2021$quintil)
...
elsoc_long_2016_2021$quintil1 <- factor(elsoc_long_2016_2021$quintil1, c("Q5","Q4","Q3","Q2","Q1","QNA"))
...
elsoc_long_2016_2021$ess <- sjmisc::rec(elsoc_long_2016_2021$ess,rec = "rev")
sjmisc::frq(elsoc_long_2016_2021$ess)

elsoc_long_2016_2021$ess <- 
sjlabelled::set_label(x = elsoc_long_2016_2021$ess,
                      label = "Subjective Social Status: individual (reverse)")
...
# Known: Immigrant [PER/VEN]____________________________
...
elsoc %>% group_by(idencuesta) %>%
  summarize(know_inm_bi_t4=know_inm_bi[ola==4],
            ...
            know_inm_t1t4 = paste0(know_inm_bi[ola==1],know_inm_bi[ola==4])
            )
sjmisc::frq(know_inm_bi$know_inm_t1t4)
know_inm_bi$know_inm_t1t4 <- 
  car::recode(know_inm_bi$know_inm_t1t4,
              recodes = "c('0NA','NA0','00')='Stable, do not know';c('1NA','NA1','11')='Stable, know';'01'='Now know';'10'='No longer know'",as.factor = T)

know_inm_bi$know_inm_t1t4 <- 
  factor(know_inm_bi$know_inm_t1t4,
         levels = c("Stable, do not know","Stable, know","Now know","No longer know"))
sjmisc::frq(know_inm_bi$know_inm_t1t4)
...
elsoc$know_inm_t1t4 <- set_label(elsoc$know_inm_t1t4,
                                  label = "Know migrants (diff. t4 - t1)")
...
elsoc %>% group_by(idencuesta) %>%
  summarize(frien_inm_bi_t4=frien_inm_bi[ola==4],
            ...
            frien_inm_t1t4 = paste0(frien_inm_bi[ola==1],frien_inm_bi[ola==4])
            )

sjmisc::frq(frien_inm_bi$frien_inm_t1t4)
frien_inm_bi$frien_inm_t1t4 <-
  car::recode(frien_inm_bi$frien_inm_t1t4,
              recodes = "c('0NA','NA0','00')='Stable, do not have friends';c('1NA','NA1','11')='Stable, have friends';'01'='Now have friends';'10'='No longer have friends';'NANA'=NA",as.factor = T)
sjmisc::frq(frien_inm_bi$frien_inm_t1t4)

frien_inm_bi$frien_inm_t1t4 <- 
  factor(frien_inm_bi$frien_inm_t1t4,
         levels = c("Stable, do not have friends","Stable, have friends",
                    "Now have friends","No longer have friends"))
sjmisc::frq(frien_inm_bi$frien_inm_t1t4)

elsoc <- left_join(x = elsoc,y = frien_inm_bi, by = "idencuesta")
sjmisc::frq(elsoc$frien_inm_t1t4)
# View(elsoc[c("idencuesta","frien_inm_bi_t4","frien_inm_bi_t1","frien_inm_t1t4")])
...
# elsoc$frien_inm_t1t4 <- factor(elsoc$frien_inm_t1t4,
#                                levels = c(-1,0,1),
#                                labels = c("No longer have",
#                                           "Constant",
#                                           "Now have"))
...
elsoc$frien_inm_t1t4 <- 
  set_label(elsoc$frien_inm_t1t4,
            label = "Have migrant friends (diff. t4 - t1)")

sjmisc::frq(elsoc$frien_inm_t1t4)
sjPlot::tab_xtab(elsoc$frien_inm_bi,elsoc$know_inm_bi)
...
df_study1_wide <- df_study1 %>% 
  tidyr::pivot_wider(id_cols = c("idencuesta","muestra"),
                     ...
                     values_from = names(select(df_study1,comuna,comunacod,cuestion_mig,in_simpat:edad,sexo))
                     )
...
df_17 <- 
casen2017 %>% 
  select(comuna,starts_with("r1"), starts_with("exp"))
sjmisc::frq(df_17$r1a)
sjmisc::frq(df_17$r1a_cod)
sjmisc::frq(df_17$r1b)
sjmisc::frq(df_17$r1b_p_cod)

# Latam & caribean 401:588
# recent migrant groups (2020) 
  # Venezuela: 513
  # Peru: 509
  # Haiti: 413
  # Colombia: 505
...
#dummy for inmigrant 
df_17$pais <- 
car::recode(df_17$r1b_p_cod,
            recodes = "c(513,509,413,505,502)=1;c(888,999)=NA;else=0",
            as.factor = T)
sjmisc::frq(df_17$pais)

# df_17$r1b[df_17$r1b==9] <- NA
# sjmisc::frq(df_17$r1b)

df_17$inm <- ifelse(test = (df_17$pais==1),yes = 1,no = 0)
...
casen20 %>% 
  select(comuna,
         starts_with("r1"),starts_with("exp"))

sjmisc::frq(df_20$r1b_p_cod)
#dummy for inmigrant 
df_20$pais <- 
car::recode(df_20$r1b_p_cod,
            recodes = "c(513,509,413,505,502)=1;c(888,999)=NA;else=0",
            as.factor = T)
sjmisc::frq(df_20$pais)


# df_20$r1b[df_20$r1b==9] <- NA
# sjmisc::frq(df_20$r1b)
df_20$inm <- ifelse(test = (df_20$pais==1),yes = 1,no = 0)
...
c("Comuna",
  "Codigo Comuna",
  "Proportion of migrant population (weighted) - CASEN 2017 - Municipality",
  "Number of migrant population - CENSUS 2017 - Municipality",
  "Proportion of migrant population - CENSUS 2017 - Municipality",
  "Number of migrant population - CIT 2017 - Municipality (using census tract)",
  "Proportion of migrant population (CIT / DEM)- CIT 2017 and INE/DEM 2017 - Communal",
  "Proportion of projected migrant population - INE/DEM 2018 - Communal",
  "Proportion of projected migrant population -  INE/DEM 2019 - Comunal",
  "Proportion of projected migrant population -  INE/DEM 2020 - Comunal",
  "Proportion of migrant population (weighted) - CASEN 2020 - Municipality",
  "Change in the proportion of the migrant population between 2017 and 2020 - CASEN")
