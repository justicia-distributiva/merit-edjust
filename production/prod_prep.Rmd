...
elsoc_long_2016_2021$educ_n<- as.numeric(
  car::recode(elsoc_long_2016_2021$m01, 
              "1=0;2=4.3;3=7.5;4=9.8;5=12.02;6=13.9;
               7=14.8;8=14.9;9=16.9;10=19.07;c(-888,-999)=NA", 
              as.numeric = T))

elsoc_long_2016_2021$educ_n <- 
sjlabelled::set_label(x = elsoc_long_2016_2021$educ_n,
                      label = "Education in years")

class(elsoc_long_2016_2021$educ_n)
sjmisc::frq(elsoc_long_2016_2021$educ_n)
...
elsoc$frien_inm_t1t4 <- set_label(elsoc$frien_inm_t1t4,
...
df_study1 <- 
elsoc_long_2016_2021 %>% 
  select(idencuesta,ola,region,region_cod,comuna,comuna_cod,
         muestra,
         cuestion_mig,
         starts_with("in_"),
         educ,educ_n,ing_pc,quintil,quintil1,
         ess,
         # ess_inm,
         nation_t1,
         know_inm,
...
sjPlot::tab_xtab(df_study1$muestra,df_study1$ola)
...
sjPlot::view_df(df_study1_2,show.frq = T,show.values = T,show.na = T,show.prc = T)
sjPlot::tab_xtab(var.row = df_study1_2$muestra,
                 var.col = df_study1_2$ola)

# sjmisc::frq(df_study1_2$ola)
# sjmisc::frq(df_study1_2$muestra)
# sjmisc::frq(df_study1_2$cuestion_mig)
# sjmisc::frq(df_study1_2$idencuesta,show.na = F) %>% data.frame() %>% View()

# Dataset fixed at t5_________________________________________________________
# keep idencuesta for the t5
id <- distinct(df_study1_2 %>% select(idencuesta,ola) %>% filter(ola==5))
# filter data by the idencuesta of t5
df_study1_3 <- 
  df_study1_2 %>%  filter(idencuesta %in% id$idencuesta)

# sjmisc::frq(df_study1_2$comuna)
# sjPlot::view_df(df_study1_3,show.frq = T,show.values = T,show.na = T,show.prc = T)
# 
# sjPlot::tab_xtab(var.row = df_study1_3$cuestion_mig,
#                  var.col = df_study1_3$ola)
# 
# sjPlot::tab_xtab(var.row = df_study1_3$muestra,
#                  var.col = df_study1_3$ola)

# sjPlot::view_df(df_study1,show.frq = T,show.values = T,show.na = T)

# SAVE DATA____________________________________________________________________
save(df_study1,file = here::here("input/data-proc/study_1.RData"))
save(df_study1_2,file = here::here("input/data-proc/study_1_2.RData"))
save(df_study1_3,file = here::here("input/data-proc/study_1_3.RData"))

# # save codebook
sjPlot::view_df(df_study1,
        show.frq = T,
        show.prc = T,
        show.na = T,
        file = here::here("output/df_study1.html"))

sjPlot::view_df(df_study1_2,
        show.frq = T,
        show.prc = T,
        show.na = T,
        file = here::here("output/df_study1_2.html"))

sjPlot::view_df(df_study1_3,
        show.frq = T,
        show.prc = T,
        show.na = T,
        file = here::here("output/df_study1_3.html"))
```
...
load(file = here::here("input/data-proc/study_1_2.RData"))
load(file = here::here("input/data-proc/study_1_3.RData"))
load(file = here::here("input/data-proc/study_1_comunas.RData"))

df_study1_ind_comunas <- 
 dplyr::left_join(x = df_study1,
                  y = df_study1_comunas, 
                  by = "comuna_cod") %>% 
...
df_study1_2_ind_comunas <- 
 dplyr::left_join(x = df_study1_2,
                  y = df_study1_comunas, 
                  by = "comuna_cod") %>% 
 dplyr::select(idencuesta:edad,
               inm_prop_cas17_w,
...
df_study1_3_ind_comunas <- 
 dplyr::left_join(x = df_study1_3,
                  y = df_study1_comunas, 
                  by = "comuna_cod") %>% 
 dplyr::select(idencuesta:edad,
               inm_prop_cas17_w,
...
# save data____________________________________________________________________
save(df_study1_ind_comunas,
     file = here::here("input/data-proc/df_study1_ind_comunas.RData"))
save(df_study1_2_ind_comunas,
     file = here::here("input/data-proc/df_study1_2_ind_comunas.RData"))
save(df_study1_3_ind_comunas,
     file = here::here("input/data-proc/df_study1_3_ind_comunas.RData"))

# save codebook
sjPlot::view_df(df_study1_ind_comunas,
        show.frq = T, 
        show.prc = T, 
        show.na = T,
        file = here::here("output/df_study1_ind_comunas.html"))

sjPlot::view_df(df_study1_2_ind_comunas,
        show.frq = T, 
        show.prc = T, 
        show.na = T,
        file = here::here("output/df_study1_2_ind_comunas.html"))

sjPlot::view_df(df_study1_3_ind_comunas,
        show.frq = T, 
        show.prc = T, 
        show.na = T,
        file = here::here("output/df_study1_3_ind_comunas.html"))
```
