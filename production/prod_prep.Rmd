...
sjlabelled::set_label(x = elsoc_long_2016_2021$quintil,
                      label = "Houshold income quintile per capita")  
...
sjlabelled::set_label(x = elsoc_long_2016_2021$quintil1,
                      label = "Houshold income quintile per capita (NA)") 
...
# Select data______________________________________________________________
...
# save data____________________________________________________________________
save(df_study1_ind_comunas,file = here::here("input/data-proc/df_study1_ind_comunas.RData"))
