...
df_study_long_t6_comunas <- 
 dplyr::left_join(x = df_study1_long_t6,
                  y = df_study1_comunas, 
                  by = "comunacod") %>% 
 dplyr::select(idencuesta:edad,sexo,
               esc_cit17) %>% 
...
df_study_long_t6_comunas <- df_study_long_t6_comunas %>% mutate(year= case_when(ola==1~2017,
                                                                            ola==2~2017,
                                                                            ola==3~2017,
                                                                            ola==4~2022,
                                                                            ola==6~2022))
...
df_study_long_t6_comunas <- 
 dplyr::left_join(x = df_study_long_t6_comunas,
                  y = select(df_gini_comunas_long, comunacod=COMUNA_COD,year, starts_with("gini"), prop_univ, starts_with("inc"), starts_with("log")), 
                  by = c("comunacod", "year"))
...
df_study_long_t6_comunas <- df_study_long_t6_comunas %>% mutate(year= case_when(ola==1~2016,
                                                                            ola==2~2017,
                                                                            ola==3~2018,
                                                                            ola==4~2019,
                                                                            ola==5~2021,
...
df_study_long_t6_comunas$prom_simce_comuna_rescaled <- df_study_long_t6_comunas$prom_simce_comuna / 10
df_study_long_t6_comunas$var_simce_comuna_rescaled <- df_study_long_t6_comunas$var_simce_comuna / 100
...
sjPlot::view_df(df_study_long_t6_comunas,
        show.frq = T, 
        show.prc = T, 
        show.na = T,
