...
df_study1 <- 
  df_study1_long_comunas %>%
  select(idencuesta,ola,comuna,just_educ:merit_talent, ahead_family:sexo, ginilag22_17, gini_ypch_2022, gini_ypch, prop_univ, gini_gc, prop_pagado, total_mat_pagado, var_simce_comuna, prom_simce_comuna, univlag22_17) %>% 
  na.omit() %>% 
...
h8 <- "ola+merit_effort+merit_talent+ahead_hardwork+ahead_educ+ahead_ambition+ahead_family+educ+quintil1+ess+pos_id+edad+sexo+gini_ypch+ginilag22_17+prop_univ+univlag22_17+var_simce_comuna+prom_simce_comuna"
...
texreg::knitreg(list(educ1, educ2, educ3, educ4, educ5, educ6, educ7,educ8),
