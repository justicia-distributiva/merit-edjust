...
h4 <- "total_mat_pagado"
h5 <- "var_simce_comuna"
h6 <- "prom_simce_comuna"
h7 <- "gini_ypch+gini_gc+prop_pagado+total_mat_pagado+var_simce_comuna+prom_simce_comuna"
...
```{r distribution-pension, eval=FALSE}
#rm(list=ls())
#if (!require("pacman")) install.packages("pacman") # instalar pacman
                            # cargar librerias
pacman::p_load(dplyr,       # Manipulacion de datos
...
```{r distribution-health, eval=FALSE}
#rm(list=ls())
#if (!require("pacman")) install.packages("pacman") # instalar pacman
                            # cargar librerias
pacman::p_load(dplyr,       # Manipulacion de datos
