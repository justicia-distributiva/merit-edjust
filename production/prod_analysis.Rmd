...
df_study1 <- 
  df_study1_long_comunas %>%
  select(idencuesta,ola,comuna,just_educ:merit_talent, ahead_family:sexo, ginilag22_17, gini_ypch_2022, gini_ypch, prop_univ, gini_gc, prop_pagado, total_mat_pagado, var_simce_comuna, prom_simce_comuna) %>% 
  na.omit() %>% 
...
h4 <- "ola+merit_effort+merit_talent+ahead_family+ahead_educ+ahead_ambition+ahead_hardwork+gini_ypch+gini_gc"
h5 <- "ola+merit_effort+merit_talent+ahead_family+ahead_educ+ahead_ambition+ahead_hardwork+gini_ypch+gini_gc+prop_pagado+total_mat_pagado+var_simce_comuna+prom_simce_comuna"
h6 <- "ola+merit_effort+merit_talent+ahead_family+ahead_educ+ahead_ambition+ahead_hardwork+gini_ypch+gini_gc+prop_pagado+total_mat_pagado+var_simce_comuna+prom_simce_comuna+educ+quintil1+ess+pos_id+edad+sexo"
...
texreg::htmlreg(list(educ.null, educ1, educ2, educ3, educ4, educ5, educ6),
...
h2b <- "gini_gc"
h3b <- "prop_pagado"
h4b <- "total_mat_pagado"
h5b <- "var_simce_comuna"
h6b <- "prom_simce_comuna"
h7b <- "gini_ypch+gini_gc+prop_pagado+total_mat_pagado+var_simce_comuna+prom_simce_comuna"
