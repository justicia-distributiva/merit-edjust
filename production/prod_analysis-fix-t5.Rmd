...
df<- dfSummary(x = dplyr::select(df_study1, ola, just_educ, des_perc, merit_effort, merit_talent, educ, quintil1, ess, pos_id, edad, sexo),
               plain.ascii = FALSE,
               style = "grid",
               tmp.img.dir = "/tmp",
               graph.magnif = TRUE,
...
merit_plot <- df_study1 %>% 
  select(merit_talent, merit_effort, des_perc, just_educ) %>% 
...
nor disagree", "Agree", "Strongly agree"),
                      axis.labels = c("Merit talent", "Merit effort", "Inequality perception", "Justification of educational inequality")
                      ) +
  theme_light() +
...
h0 <- "ola"
h1 <- "ola_num+ola_2"
h2 <- "ola_num+ola_2+des_perc"
h3 <- "ola_num+ola_2+des_perc+merit_talent"
h4 <- "ola_num+ola_2+des_perc+merit_talent+merit_effort"
h5 <- "ola_num+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo"
...
texreg::htmlreg(list(educ0, educ1, educ2, educ3, educ4, educ5),
                custom.note = "*** p < 0.001; ** p < 0.01; * p < 0.05. Model 6 is controlled by educational level, and subjective social status with no significant effects.", 
                omit.coef = omit,
...
# Hipotesis
h1b <- "ola+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo"
h2b <- "ola+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*des_perc"
h3b <- "ola+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*merit_talent"
h4b <- "ola+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*merit_effort"
h5b <- "ola+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*pos_id"
h6b <- "ola+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*edad"

# A. Education distributive justice
educ.null <- lmer(formula(paste0("just_educ~","1 + (1|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ1 <- lmer(formula(paste0("just_educ~",h1b,"+(1|idencuesta)")),data = df_study1, weights = ponderador_long_total)
educ2 <- lmer(formula(paste0("just_educ~",h2b,"+(1|idencuesta)")),data = df_study1, weights = ponderador_long_total)
...
# table 3: interacciones
omit <- "(education)|(ess)|(quintil1)|(sexo)"
texreg::htmlreg(list(educ2,educ3,educ4,educ5,educ6),
                ...
                custom.coef.names = c("Intercept",
                                      ...
                                      "Edad 50-64",
                                      "Edad 65 o más",
                                      "2017*inequality perception",
                                      "2018*inequality perception",
                                      "2019*inequality perception",
                                      "2022*inequality perception",
                                      "2017*merit:talent",
                                      "2018*merit:talent",
                                      "2019*merit:talent",
                                      "2022*merit:talent",
...
# Hipotesis
h1b <- "ola+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo"
h2b <- "ola+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*des_perc"
h3b <- "ola+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*merit_talent"
h4b <- "ola+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*merit_effort"
h5b <- "ola+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*pos_id"
h6b <- "ola+ola_2+des_perc+merit_talent+merit_effort+education+quintil1+ess+pos_id+edad+sexo+ola*edad"
...
texreg::htmlreg(list(educ2,educ3,educ4,educ5,educ6),
                ...
                file = "output/tables/table3-interac_pond-numeric.html")
          #omit.coef = omit



webshot2::webshot(url ="output/tables/table3-interac_pond-numeric.html" ,file ="output/tables/table3-interac-pond-numeric.png")
