...
years_plot <- years_plot +
  ...
  geom_text(data = label_data, aes(label_x, label_y, label = variable), color = "black", hjust = 0, nudge_x = 0.05, nudge_y = 0, size = 4)  +
  labs(caption = "Source: own elaboration with pooled data from ELSOC 2016-2022 (n = 8042)")
...
from ELSOC 2016-2022 (n = 8042)", x = 0.01, y = 0.05, just = "left", gp = grid::gpar(fontsize = 10, col = "black"))
dev.off()
...
Note: Model 3 to 7 are controlled by educational level, and subjective social status with no significant effects.", 
                omit.coef = omit,
...
h2b <- "ola+ola_2+education+quintil1+ess+edad+sexo+pos_id+merit_effort+merit_effort*ola+merit_effort*ola_2"
h3b <- "ola+ola_2+education+quintil1+ess+edad+sexo+pos_id+merit_talent+merit_talent*ola+merit_talent*ola_2"
...
# table 3: interacciones
omit <- "(education)|(ess)|(quintil1)|(edad)|(sexo)|(pos_id)"
texreg::htmlreg(list(educ2,educ3,educ4),
                custom.note = "*** p < 0.001; ** p < 0.01; * p < 0.05. <br>
Note: All the models are controlled by educational level, income quintile, subjective social status, age, gender and political position",
                omit.coef = omit,
                custom.coef.names = c("Intercept",
                                      "Wave",
                                      "Wave^2",
                ...
                custom.gof.names = c("AIC", "BIC", "Log Likelihood",
                                     ...
                                     "Var: Individuals Wave^2",
                                     "Var: Individuals Merit: Effort",
                                     "Cov: Individuals (Intercept) Wave",
                                     "Cov: Individuals (Intercept) Wave^2",
                                     "Cov: Individuals (Intercept) Merit: Effort",
                                     "Cov: Individuals Wave Wave^2",
                                     "Cov: Individuals Wave Merit: Effort",
                                     "Cov: Individuals Wave^2 Merit: Effort",
                                     "Var: Residual",
                                     "Var: Individuals Merit: Talent",
                                     "Cov: Individuals (Intercept) Merit: Talent",
                                     "Cov: Individuals Wave Merit: Talent",
                                     "Cov: Individuals Wave^2 Merit: Talent",
                                     "Var: Individuals Inequality perception",
                                     "Cov: Individuals (Intercept) Inequality perception",
                                     "Cov: Individuals Wave Inequality perception",
                                     "Cov: Individuals Wave^2 Inequality perception"
                                     ),
