...
df_study1 <- df_study_long_t7_comunas %>% dplyr::select(ola,
...
df<- dfSummary(x = dplyr::select(df_study1, ola, merit_talent, merit_effort, des_perc, educ, quintil1, ess, edad, sexo, pos_id),
               plain.ascii = FALSE,
               style = "grid",
               tmp.img.dir = "/tmp",
               graph.magnif = TRUE,
...
alluvial_justeduc <- ggplot(datos.justeduc, aes(x = ola, fill = just_educ, stratum = just_educ,
  ...
  labs(caption = "Source: own elaboration with pooled data from ELSOC 2016-2023 (n = 9519)")
...
educational inequality")
  ...
  theme(legend.position="bottom", text = element_text(size = 14),
        plot.caption = element_text(hjust = 1)) +
  labs(caption = "Source: own elaboration with pooled data from ELSOC 2016-2022 (n = 9519)")
merit_plot
...
from ELSOC 2016-2023 (n = 9519)", x = 0.01, y = 0.05, just = "left", gp = grid::gpar(fontsize = 10, col = "black"))
dev.off()
