...
likert1<-   
  cowplot::add_sub(
    cowplot::plot_grid(p_ansied,p_simpat,p_convi,p_simili,p_identi,p_threat, 
                       align = "hv",
                       axis = "a",
                       nrow = 6, #4 plots
                       ncol = 1, #1 column
                       rel_heights = c(s,s,m,s,l,s) #fig size within plot
    ),
  ...
  cowplot::ggdraw()  
# likert1
ggplot2::ggsave(filename = "plot_likert2.png",
                plot = likert1,
...
likert1<-   
  ...
  cowplot::ggdraw()  
likert1
ggplot2::ggsave(filename = "plot_likert.png",
                plot = likert1,
                path = here::here("output/images"),
                device = "png",
                units = "cm",
...
png(file=here::here("output/images/plot_corr.png"),width=900, height=700)
corrplot::corrplot(cor_full,
  method = "color",
  addCoef.col = "#000390",
  type = "upper",
