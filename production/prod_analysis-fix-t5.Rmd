...
df_study1$in_ansied <- factor(df_study1$in_ansied,1:5,get_labels(df_study1$in_ansied))
df_study1$in_simpat <- factor(df_study1$in_simpat,1:5,get_labels(df_study1$in_simpat))
df_study1$in_valfam <- factor(df_study1$in_valfam,1:5,get_labels(df_study1$in_valfam))
df_study1$in_valami <- factor(df_study1$in_valami,1:5,get_labels(df_study1$in_valami))
df_study1$in_amigcl <- factor(df_study1$in_amigcl,1:5,get_labels(df_study1$in_amigcl))

df_study1$in_simili <- factor(df_study1$in_simili,1:5,get_labels(df_study1$in_simili))
df_study1$in_amsimb <- factor(df_study1$in_amsimb,1:5,get_labels(df_study1$in_amsimb))
df_study1$in_acpier <- factor(df_study1$in_acpier,1:5,get_labels(df_study1$in_acpier))
df_study1$in_acadop <- factor(df_study1$in_acadop,1:5,get_labels(df_study1$in_acadop))

df_study1$in_amreal <- factor(df_study1$in_amreal,1:5,get_labels(df_study1$in_amreal))
